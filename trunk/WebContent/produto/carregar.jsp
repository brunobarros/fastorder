	...
	<table id="form">
		<tr>
			...
			<td>
				...
				<input type="text" name="produto.descricao" value="<ww:property value="produto.descricao" />" />
			</td>
		</tr>
		<tr>
			<td>Preço:</td>
			<td><input type="text" name="produto.descricao" value="<ww:property value="produto.preco" />" /></td>
		</tr>
		<tr>
			<td>Tipo:</td>
			<td>
